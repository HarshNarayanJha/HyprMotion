...
let isHomePage = $derived(page.url.pathname === resolve("/"))
</script>
...
<div
  class={[
    "grid grid-cols-[1fr_3fr_1fr] place-content-center items-center justify-items-center",
    isHomePage ? "sticky top-4" : "mt-4"
  ]}>
  <nav
    style="--radius: 4rem;"
    class={[
